...
const HeroSection = ({ onEnter, loading }: HeroSectionProps) => {
  ...
  // ADJUSTED: Stats now disappear completely by 0.7
  ...
  // CTA appears from 0.75 onwards, ensuring the previous section is gone
  ...
  // Cart fades out as the final section locks in
  ...
  return (
    <div ref={containerRef} className="relative" style={{ height: "500vh" }}>
      <div className="fixed inset-0 overflow-hidden">
        ...
        {/* Viewport 3-4: Platforms Section (Previous Section) */}
        ...
        <motion.div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none z-20" style={{ x: cartX, y: cartY, scale: cartScale, rotate: cartRotate, opacity: cartOpacity }}>
          <img src={heroCart} alt="Smart Basket" className="w-48 sm:w-64 md:w-80 drop-shadow-[0_0_60px_hsl(var(--glow)/0.3)]" />
        </motion.div>
